        ...
        <>
            ...
            <div className="main_for_all_pages">
                ...
                <div className="news_row">
                    {news.value.news.map((item,index)=><NewsItemLk key={index} date={item.created_at} bgr={item.avatar} text={item.text}/>)}
